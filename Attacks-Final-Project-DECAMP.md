...
**Note:** Since the attacker is in the *Clients* zone and the victim is in the *LAB* zone, this attack aims to saturate the firewall's routing capacity and fill the state table with ICMP connections.
...
- **Network:** High latency for traffic passing between Clients and LAB.
